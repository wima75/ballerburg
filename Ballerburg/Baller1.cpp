...
// diese hässlichen Variablen-Namen stammen aus dem Original-Source-Code.
double vvx,vvy;
...
char  f, mod, wnd, end, txt[4], an_erl, mxin, au_kap,
      cw[2]={2,2}, cx[2]={1,1}, cn[7][8]={ "T�lpel","Dummel","Brubbel",
      "Wusel","Br�sel","Toffel","R��pel" },
      t_na[6][8]={ "T�lpel","Dummel","Brubbel","Wusel","Br�sel","Toffel" },
      nsp1[22]="Hugo",nsp2[22]="Emil";
	  //nsp1[22]="T�lpel",nsp2[22]="Wusel";
...
void ende()
{
	...
	*(char **)(a_sie+24*SG3+12)=s3;
	...
	switch( end&240 )
	{
	case 16: strcat_s( s2,"K�nig wurde getroffen," );
		strcpy_s( s3,"  daraufhin ergab sich dessen Volk. )" ); break;
	case 32: strcat_s( s2,"K�nig hat aufgrund der" );
...
void cls() /* L�scht den gesamten Bildschirm ausser der Men�leiste */
{
	int *a,i;
